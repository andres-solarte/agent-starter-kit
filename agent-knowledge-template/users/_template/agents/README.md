...
- Tracked in agent-knowledge (roaming across your machines via `git pull`).
- **Not** team SoT — do not list in global `roles.md` unless **promoted** (user confirms team scope).
