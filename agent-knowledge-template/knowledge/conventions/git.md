...
After a meaningful block/loop close, or after durable tracked writes (deltas, `session-backlog.md`, requirement registry, roles, team/user `agents/ask-*.md`, agreed `knowledge/**`):
