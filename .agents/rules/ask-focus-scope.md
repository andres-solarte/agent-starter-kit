...
1. Follow the **`ask-backlog`** skill (`.agents/skills/ask-backlog/SKILL.md`): bullet in `agent-knowledge/users/<email>/session-backlog.md` (per user; not under `.cursor/`).
2. Acknowledge in **one sentence** (what was parked).
...
Offer to review the parked list or tackle a specific item — do not clear it on your own.
